...
In this example we don't test for independence of variables, multicollinearity, variance inflation, or normality of residuals. These practices all still apply in multi-model inference, but were left out of this guide for consideration of the reader's time.
